...
$BIN $OPT_OUTPUT=tests/rand3.dtw $OPT_TYPE=rand $OPT_PARAM="start=(0,0) angle=(-0.2,0.2) step=(2,4) n=500"
$BIN $OPT_OUTPUT=tests/rand4.dtw $OPT_TYPE=rand $OPT_PARAM="start=(0,-10) angle=(-0.2,0.2) step=(2,4) n=500"