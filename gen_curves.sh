...
$BIN $OPT_OUTPUT=data/rand1.dtw $OPT_TYPE=rand $OPT_PARAM="start=(0,0) angle=(-0.5,0.5) step=(1,2) n=500"
$BIN $OPT_OUTPUT=data/rand2.dtw $OPT_TYPE=rand $OPT_PARAM="start=(0,-20) angle=(-0.5,0.5) step=(1,2) n=500"
