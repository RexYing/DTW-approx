...
#$EXE --v=6 --curve1=data/input4_1.txt --curve2=data/input4_2.txt --rects_output_file="results/rects_input4.txt" --align_output_file="results/rects_input4_align.txt" --exact_align_output_file="results/rects_input4_exact_align.txt" --approx_frechet_align_output_file="results/rects_input4_approx_frechet_align.txt" --exact_frechet_align_output_file="results/rects_input4_exact_frechet_align.txt" --eps=1.0

$EXE --v=6 --curve1=data/rand5.dtw --curve2=data/rand6.dtw --rects_output_file="results/rects_rand_5_6.txt" --align_output_file="results/rects_rand_5_6_align.txt" --exact_align_output_file="results/rects_rand_5_6_exact_align.txt" --approx_frechet_align_output_file="results/rects_rand_5_6_approx_frechet_align.txt" --exact_frechet_align_output_file="results/rects_rand_5_6_exact_frechet_align.txt" --eps=2.0
